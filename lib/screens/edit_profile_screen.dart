...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  void initState() {
    ...
    _selectedPremiseCode = widget.profile['premise_code'];
  ...
  Future<void> _loadPremises() async {
    try {
      ...
      ScaffoldMessenger.of(context)
          .showSnackBar(SnackBar(content: Text('Failed to load premises: $e')));
    }
  }
  ...
  Future<void> _saveProfile() async {
    ...
    if (widget.isSeller && _selectedPremiseCode == null) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text('Please select a premise')));
    ...
    try {
      await _profileService.updateSellerProfile(
        ...
        premiseCode: widget.isSeller ? _selectedPremiseCode : null,
      );
